...
---
<!-- KEPT AND RESTYLED. The category index, in the design's bracket-and-rule
     grammar. Post links still resolve to /blog/categories/#slug from the
     posts' own category rows, so the anchors below must keep the slugified
     name as their id. -->
